...
nmap('<Leader>wk', '<cmd>10<C-w>+<cr>')
nmap('<Leader>wj', '<cmd>10<C-w>-<cr>')
nmap('<Leader>wr', '<cmd><C-w>r<cr>')
nmap('<Leader>wo', "<cmd><C-w>o<cr>")
nmap('<Leader>we', "<cmd><C-w>=<cr>")
nmap('<Leader>wV', "<cmd><C-w>H<cr>")
nmap('<Leader>wS', "<cmd><C-w>J<cr>")
