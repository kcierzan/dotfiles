...
* UI
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (add-hook 'prog-mode-hook 'hl-line-mode)
     ...
     (set-face-attribute 'fixed-pitch nil :font "FuraCode Nerd Font Retina")
     (set-face-attribute 'default  nil :font "FuraCode Nerd Font Retina")
    (set-face-attribute 'variable-pitch nil :font "Bitter" :height 140 :weight 'medium)
...
** General
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package general
       ...
       (general-create-definer org-leader :prefix "SPC o" :keymaps 'override :states '(normal visual motion))
