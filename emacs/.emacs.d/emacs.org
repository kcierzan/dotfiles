...
**** hippie-exp
     ...
     #+END_SRC
**** lsp-mode
     An elisp implementation of the language server protocol from VS Code
     #+name: programming
     #+BEGIN_SRC emacs-lisp
...
**  Final
   ...
   #+BEGIN_SRC emacs-lisp
     (load custom-file)
     (set-face-attribute 'powerline-active1 nil :background nil :foreground nil :inherit 'highlight :family "SFMono Nerd Font")
     (set-face-attribute 'powerline-active2 nil :background (face-attribute 'fringe :foreground) :inherit nil)
     (set-face-attribute 'powerline-inactive2 nil :background (face-attribute 'fringe :foreground) :inherit nil :family "SFMono Nerd Font")
     (set-face-attribute 'mode-line nil :background (face-attribute 'shadow :background) :inherit nil :family "SFMono Nerd Font")
     (set-face-attribute 'spaceline-highlight-face nil :background (face-attribute 'org-code :foreground) :family "SFMono Nerd Font")
   #+END_SRC
* Tangle
