...
**** hippie-exp
     ...
     #+END_SRC
**** lsp-mode
     An elisp implementation of the language server protocol from VS Code. Doesn't work at the moment.
     #+name: programming
     #+BEGIN_SRC emacs-lisp
       (use-package lsp-mode
         ...
         (lsp-define-stdio-client
          ...
          '("pyls"))
         (add-hook 'python-mode-hook #'my-lsp-python-enable)
...
**** company-lsp
    ...
    #+BEGIN_SRC emacs-lisp
       (use-package company-lsp
         ...
         ;; :after lsp-mode
         :init
         (setq company-lsp-cache-candidate 'auto
               company-lsp-async t
...
**** projectile
     ...
     #+BEGIN_SRC emacs-lisp
       (use-package projectile
         ...
         ;; (defun kyle*projectile-locate-dominating-file (orig-fn &rest args)
         ;;   "Don't traverse the file system if on a remote connection"
         ;;   (unless (file-remote-p default-directory)
         ;;     (apply orig-fn args)))
         ;; (advice-add #'projectile-locate-dominating-file :around #'kyle*projectile-locate-dominating-file)
         (projectile-mode 1))
     #+END_SRC
*** Editing
**** smartparens
