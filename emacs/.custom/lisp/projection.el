...
;;; Code:
;;;
(defvar doom-cache-dir (expand-file-name "~/.custom/cache/"))
(defvar doom-local-dir (expand-file-name "~/.custom/.local/"))
(setq projectile-project-search-path '(("~/git" . 2) ("~/src" . 2) ("~/.dotfiles")))
(setq doom--system-windows-p nil)
