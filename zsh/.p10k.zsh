# Generated by Powerlevel10k configuration wizard on 2019-08-02 at 17:28 EDT.
...
() {
  ...
  vcs+='${${VCS_STATUS_LOCAL_BRANCH:+%2F${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${VCS_STATUS_LOCAL_BRANCH//\%/%%}}'
  ...
  vcs+='${${VCS_STATUS_NUM_UNTRACKED:#0}:+ %5F${(g::)POWERLEVEL9K_VCS_UNTRACKED_ICON}${VCS_STATUS_NUM_UNTRACKED}}'
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=5
